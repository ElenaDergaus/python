...
class Cell:
    ...
    def __sub__(self, other):
        if self.cell_amount > other.cell_amount:
            ...
            print("Нельзя вычесть! В первой клетке ячеек меньше чем во второй!")
    ...
    def make_order(self, count):
        a = self.cell_amount // count
        b = self.cell_amount % count
        order = ((('*'* count)+'\n')*a)+'*'*b
        print(order)
...
cell2 = Cell(16)
cell3 = cell1 + cell2
print(cell3.cell_amount)
cell4 = cell2 - cell1
cell5 = cell1*cell2
print(cell5.cell_amount)
cell6 = cell1/cell2
print(cell6.cell_amount)
cell1.make_order(9)